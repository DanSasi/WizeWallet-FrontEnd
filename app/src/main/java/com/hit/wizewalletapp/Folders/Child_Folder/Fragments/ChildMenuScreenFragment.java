...
public class ChildMenuScreenFragment extends Fragment implements ChildMenuAdapterClass.ListViewHolder.RecycleViewClickListener {
    ...
    ArrayList<MenuParentModelClass> menu_items;
...
//        menu_items.add(new MenuModelClass(1, R.drawable.icon, "Send Money"));
        menu_items.add(new MenuParentModelClass("3", R.drawable.icon5, "History Transaction"));
        menu_items.add(new MenuParentModelClass("4", R.drawable.icon6, "Request Payment"));
        menu_items.add(new MenuParentModelClass("5", R.drawable.icon7, "Settings"));
        menu_items.add(new MenuParentModelClass("6", R.drawable.icon_logout, "Logout"));
    }
