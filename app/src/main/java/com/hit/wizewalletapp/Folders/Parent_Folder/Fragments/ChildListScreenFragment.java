...
public class ChildListScreenFragment extends Fragment implements ChildListAdapter.RecyclerViewClickListener{
    ...
    public void onClick(int position) {
        Intent intent = new Intent(getActivity(), SendMoneyScreenFragment.class);
