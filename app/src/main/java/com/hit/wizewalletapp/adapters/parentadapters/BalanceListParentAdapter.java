package com.hit.wizewalletapp.adapters.parentadapters;
...
public class BalanceListParentAdapter extends RecyclerView.Adapter<BalanceListParentAdapter.BalanceViewHolder>{
    ...
    public BalanceListParentAdapter(Context context, List<TransactionModel> bData) {
