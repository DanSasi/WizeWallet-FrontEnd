...
public class ChildMenuAdapterClass extends RecyclerView.Adapter<ChildMenuAdapterClass.ListViewHolder>{
    ...
    public ChildMenuAdapterClass(Context context, List<MenuModelClass> menu_items, ChildMenuAdapterClass.ListViewHolder.RecycleViewClickListener listener) {
...
//    }
    ...
    public ListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout;
        layout = LayoutInflater.from(context).inflate(R.layout.activity_menu_screen_child_list1,parent,false);
