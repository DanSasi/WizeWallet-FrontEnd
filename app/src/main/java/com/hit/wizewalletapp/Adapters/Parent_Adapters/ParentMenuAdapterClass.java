...
public class ParentMenuAdapterClass extends RecyclerView.Adapter<ParentMenuAdapterClass.ListViewHolder>{

    Context context;
    List<MenuModelClass> menu_items;
    private ListViewHolder.RecycleViewClickListener clickListener;

    public ParentMenuAdapterClass(Context context, List<MenuModelClass> menu_items, ListViewHolder.RecycleViewClickListener listener) {
