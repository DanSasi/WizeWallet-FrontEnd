...
//        });
        ...
        topup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoTopup = new Intent(ChildBalanceScreen.this, TasksScreen.class);
        ...
        tips.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoTips = new Intent(ChildBalanceScreen.this, TipsScreen.class);
        ...
        more.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoMore = new Intent(ChildBalanceScreen.this, MenuScreen.class);
...
//        });
        ...
        topupText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoTopupText = new Intent(ChildBalanceScreen.this, TasksScreen.class);
        ...
        tipText.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotoTipText = new Intent(ChildBalanceScreen.this, TipsScreen.class);
    ...
    public void recycleViewClick(int position) {
        Intent intent = new Intent(ChildBalanceScreen.this, TransactionHistoryActivity.class);
