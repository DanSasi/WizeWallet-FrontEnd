...
public class ChildTransactionHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_child_history);
    ...
    private void setDataAdapter() {
        balanceListAdapter = new BalanceListParentAdapter(ChildTransactionHistoryActivity.this, bData);
